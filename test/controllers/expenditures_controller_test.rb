...
class ExpendituresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create expenditure" do
    assert_difference('Expenditure.count') do
      post expenditures_url, params: { expenditure: { description: @expenditure.description, expense: @expenditure.expense, title: @expenditure.title } }
    end
  ...
  test "should update expenditure" do
    patch expenditure_url(@expenditure), params: { expenditure: { description: @expenditure.description, expense: @expenditure.expense, title: @expenditure.title } }
